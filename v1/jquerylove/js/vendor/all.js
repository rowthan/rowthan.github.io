...
/*	--------------------------------------------------------------------
	...
	background slideshows.  It is intended to be v1 alongside the
	jQuery Cycle plugin: 
...
(function ($) {
	...
	$.fn.maximage.defaults = {
		debug: false,
		cssBackgroundSize: true,  // Force run the functionality v1 for newer browsers
		cssTransitions: true,  // Force run the functionality v1 for old browsers
